...
<head>
    ...
    <title>Éditer Employé - Admin</title>
...
<body>
    ...
    <div class="main-content">
        <!-- Topbar -->
        <div class="topbar">
            <h1><i class="fas fa-user-edit"></i> Éditer l'Employé</h1>
            ...
            <form action="{{ route('admin.employes.update', $employe->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" 
                        id="name" name="name" value="{{ old('name', $employe->name) }}" required>
                    @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('role') is-invalid @enderror" id="role" name="role" required>
                            @foreach($roles as $role)
                                <option value="{{ $role }}" {{ old('role', $employe->role) === $role ? 'selected' : '' }}>
                                    {{ ucfirst($role) }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="two-columns">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('date_embauche') is-invalid @enderror" 
                            id="date_embauche" name="date_embauche" value="{{ old('date_embauche', $employe->date_embauche?->format('Y-m-d')) }}" required>
                        @error('date_embauche')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="two-columns">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('numero_id') is-invalid @enderror" 
                            id="numero_id" name="numero_id" value="{{ old('numero_id', $employe->numero_id) }}">
                        @error('numero_id')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
